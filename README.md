...
`Test-ReportQueries.ps1` was run against the P01 lab site (CM01, `CM_P01`): all 18 datasets
...
rendered through URL access on CM01, and the numbers are the ones the site holds:
...
| Details (`ComputerName=CLIENT02`) | 7-Zip 26.02 and Notepad++ 8.9.8, both `Installiert` |
| Details (Alle Apps) (`ComputerName=CLIENT02`) | the client's full ARP list |
